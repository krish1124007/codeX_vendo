...
import { getProcurementDashboardKpis, getMonthlyTrend } from "@/services/analytics";
...
export async function ProcurementDashboard({ user }: { user: User }) {
  ...
  return (
    <>
      <PageHeader
        ...
        subtitle={`Welcome back, ${user.name} — Procurement Overview`}
        actions={
          <>
            <Link href="/rfqs/new">
              <Button size="sm">
